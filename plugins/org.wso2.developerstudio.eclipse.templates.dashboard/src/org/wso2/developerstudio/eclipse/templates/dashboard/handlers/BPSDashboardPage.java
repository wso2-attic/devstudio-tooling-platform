 ...
 *
 */
public class BPSDashboardPage extends FormPage {
     ...
     * @param title
     */
    public BPSDashboardPage(String id, String title) {
        super(id, title);
    }
     ...
     */
    public BPSDashboardPage(FormEditor editor, String id, String title) {
    ...
    protected void createFormContent(IManagedForm managedForm) {
        ...
        sctnCreate.setText("BPS Templates");
