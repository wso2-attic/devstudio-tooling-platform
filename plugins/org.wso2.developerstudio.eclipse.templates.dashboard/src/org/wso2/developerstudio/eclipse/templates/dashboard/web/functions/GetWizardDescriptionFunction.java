...
/**
 * This defines the GetWizardDescription function which returns the description string in wizard extension point
 * Call this function in JS with GetWizardDescription(wizardID);
 */
public class GetWizardDescriptionFunction extends BrowserFunction {
    ...
    public GetWizardDescriptionFunction(Browser browser) {
        super(browser, "GetWizardDescription"); //Call this function in JS with GetWizardDescription(wizardID);
    }
