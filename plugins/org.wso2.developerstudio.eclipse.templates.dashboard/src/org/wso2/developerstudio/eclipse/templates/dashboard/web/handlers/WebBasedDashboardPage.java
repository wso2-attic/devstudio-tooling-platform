...
public class WebBasedDashboardPage extends AbstractWebBasedEditor {

    private static final String WEB_APP_PATH = "ToolingDashboard";

    public WebBasedDashboardPage() {
        super();
    }

    public WebBasedDashboardPage(MultiPageEditorPart multiPageEditor) {
        super(multiPageEditor);
    }

    @Override
    public String getEditorName() {
        return WebDashBoardEditorConstants.HUMAN_TASK_EDITOR_NAME;
    }
    ...
    public String getEditorURL() throws WebUIException {
        ...
        try {
            ...
            resolvedWebAppIndex = new File(resolvedWebAppFolder, WebDashBoardEditorConstants.INDEX_HTML_FILE_NAME);
